...
public class TransactionManagerTest {
    ...
    public void setUp() {
        ...
        transactionManager = new TransactionManager.Builder(caverj, walletManager)
    ...
    public void testAccountUpdate() throws Exception {
        ...
        TransactionManager updateTransactionManager = new TransactionManager.Builder(caverj, credentials)
                .setTransactionReceiptProcessor(new PollingTransactionReceiptProcessor(caverj, 1000, 15))
                .build();
    ...
    public void testCancel() {
        ...
        caverj.klay().sendSignedTransaction(rawContractDeploy).sendAsync();
